...
# python train_dqn_against_baseline.py --env SlimeVolley-v0 --max-frames 10000000 > log/$DATE$RAND.log &
python train_dqn_against_baseline.py --env SlimeVolleyNoFrameskip-v0 --max-frames 30000000 > log/$DATE$RAND.log &
