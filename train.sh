...
# python train_dqn_against_baseline_mp.py --env SlimeVolley-v0 --buffer-size 1000000 --num-envs 10 --hidden-dim 512 --train-freq 100 --batch-size 1024 --max-frames 500000000 > log/$DATE$RAND.log &
