...
python train_dqn_against_baseline_mp.py --env SlimeVolley-v0 --dueling --eps-final 0.1 --gamma 0.99 --eps-decay 1000000 --buffer-size 1000000 --num-envs 10 --hidden-dim 256 --train-freq 10 --batch-size 1024 --max-frames 500000000 > log/$DATE$RAND.log &
